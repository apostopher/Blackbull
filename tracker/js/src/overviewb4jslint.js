      ...
      $.ajax({
          ...
          success: function(response){
            if(response.status == "1"){
              $("#resulttxt").html("Transaction added successfully!<br/><span class=\"undotxt\"><a id=\"undoa\" data-trsid=\""+response.trans_id+"\" data-trid=\""+trid+
     ...
     if(jsontrades.pagefound == "1"){
       ...
       if(jsontrades.targetstotal > 0){
         ...
         for(var count=0; count < jsontrades.targetstotal; count++){
           ...
           targethtml += "<td class=\"trcontrol lastcell\">&nbsp;</td></tr>";
       ...
       if(jsontrades.sltotal > 0){
         ...
         for(var count=0; count < jsontrades.sltotal; count++){
           ...
           slhtml += "<td class=\"trcontrol lastcell\">&nbsp;</td></tr>";
           /* reset active value after first run */
           activevalue ="";
         }
